        ...
        <section className="wrap-md w-full wrap-px pt-4 mx-auto">
            <div className="grid grid-cols-6 gap-4">
                ...
                <motion.div initial="hidden" animate="show" variants={variants} className="col-span-6">
                    <div className="flex flex-wrap gap-4 content-start bg-neutral-300/20 relative p-8 sm:p-12 border aspect-video md:aspect-[3/1] border-neutral-400/30 rounded-xl shadow-sm overflow-hidden">
                        <div className="image-container absolute flex w-full h-full inset-y-0 bottom-0 items-center right-0 flex-1 bg-[url('/div.flex.png')] bg-cover bg-center bg-no-repeat">
                            <span className="ml-10 w-3/5 block text-xl sm:text-4xl">
                                Helping users <span className="underline">understand</span> why content is classified as <span className="underline">toxic</span>
                            </span>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div initial="hidden" animate="show" variants={variants} className="col-span-6 sm:col-span-2">
                    <Link href="/team" className="flex flex-wrap gap-4 content-start relative py-4 px-12 border border-neutral-400/30 rounded-xl shadow-sm overflow-hidden bg-red-600 hover:bg-red-700 transition-colors duration-300">
                ...
                {/* Boton 2 */}
                <motion.div initial="hidden" animate="show" variants={variants} className="col-span-6 sm:col-span-2">
                    <Link href="/report" className="flex flex-wrap gap-4 content-start relative py-4 px-12 border border-neutral-400/30 rounded-xl shadow-sm overflow-hidden hover:bg-red-600 hover:text-white transition-colors duration-300">
                ...
                {/* Boton 3 */}
                <motion.div initial="hidden" animate="show" variants={variants} className="col-span-6 sm:col-span-2">
                    <Link href="mailto:detoxigram@gmail.com" className="flex flex-wrap gap-4 content-start relative py-4 px-12 border border-neutral-400/30 rounded-xl shadow-sm overflow-hidden bg-red-600 hover:bg-red-700 transition-colors duration-300">
                        <div className="content w-full text-white text-center">
                            <span>Contact</span>
                        </div>
                    </Link>
                ...
                <div className="grid col-span-3 grid-row-3 gap-4">
                    ...
                    <motion.div initial="hidden" animate="show" variants={variants} className="col-span-6 sm:col-span-3 md:col-span-3">
                        <div className="flex flex-wrap w-full h-full md:h-full content-start bg-[url('/analyze.png')] bg-cover bg-center bg-no-repeat relative aspect-square md:aspect-auto py-8 border border-neutral-400/30 rounded-xl shadow-sm overflow-hidden items-center">
                            <div className="relative h-full w-full flex flex-col justify-start items-center">
                                <div className="content flex flex-col sm:flex-row gap-4 sm:gap-10 text-black justify-center md:max-w-64 relative z-10">
                                    <div className="flex items-center justify-start">
                                        <h2 className="text-2xl sm:text-2xl md:text-2xl sm:w-3/4 text-center sm:text-left mb-0">
                                            <span className="underline">Analyze</span> content
                                        </h2>
                    ...
                    <motion.div initial="hidden" animate="show" variants={variants} className="col-span-6 sm:col-span-3 md:col-span-3">
                        <div className="flex flex-wrap w-full h-full md:h-full content-start bg-[url('/analyze.png')] bg-cover bg-center bg-no-repeat relative aspect-square md:aspect-auto py-8 border border-neutral-400/30 rounded-xl shadow-sm overflow-hidden items-center">
                            <div className="relative h-full w-full flex flex-col justify-start items-center">
                                <div className="content flex flex-col sm:flex-row gap-4 sm:gap-10 text-black justify-center md:max-w-64 relative z-10">
                                <div className="flex items-center justify-start">
                                    <h2 className="text-2xl sm:text-2xl md:text-2xl mb-0 w-full sm:w-3/4 text-center sm:text-left">
                                        <span className="underline">Understand</span> how toxic it is and why
                                    </h2>
                                    <img src="/Foco.png" alt="Lupa" className="w-full sm:w-9/12 h-auto" />
                                </div>
                                </div>
                                <div className="image-container absolute flex bottom-0"></div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    {/* Div Número 4 */}
                    <motion.div initial="hidden" animate="show" variants={variants} className="col-span-6 sm:col-span-3 md:col-span-3">
                        <div className="flex flex-wrap w-full h-full md:h-full content-start bg-[url('/detoxify.png')] bg-cover bg-center bg-no-repeat relative aspect-square md:aspect-auto py-8 border border-neutral-400/30 rounded-xl shadow-sm overflow-hidden items-center">
                            <div className="relative h-full w-full flex flex-col justify-start items-center">
                                <div className="content flex flex-col sm:flex-row gap-4 sm:gap-10 text-black justify-center md:max-w-64 relative z-10">
                                <div className="flex items-center justify-start">
                                    <h2 className="text-2xl sm:text-2xl md:text-2xl mb-0 w-full sm:w-3/4 text-center sm:text-left">
                                        <span className="underline">Detoxify</span> messages
                                    </h2>
