...
Participants rated the toxicity of 30 messages (sourced from different Telegram channels) on the 5-point scale (0-4) mentioned before. Attention checks were incorporated to ensure data quality, and participants failing two or more of them were excluded from compensation. A £0.90 incentive was provided upon successful completion to encourage engagement and maintain data quality. We used the recollected data as ground truth for our classifier.
                      ...
                      <div>
                        ...
                        <p className="w-full text-xl text-justify mt-5 mb-5">
                          The first question we had to answer when choosing the generative LLM to use for this project was: Are we aiming to deploy a full model for this project, or do we prefer using external services provided by companies, such as OpenAI, Anthropic or MistralAI?<br /><br />
                          ...
                          We decided to use Mixtral of Experts (JIANG, Albert Q., et al. Mixtral of experts. 2024), an LLM from Mistral AI, which we found to be the best option with respect to cost and performance trade-offs. Choosing this model also allows us to potentially fine-tune it or deploy it locally if we ever decide to.<br /><br />
                        </p>
                      </div>
